...
def waz():
    ...
    while(run):
        ...
        #rysowanie jabłka
        pygame.draw.circle(oknoGry,(255,1,1),(jablkoX+30,jablkoY+30),30)
        #rysowanie węża
        #sprawdzamy dlugosc weza
